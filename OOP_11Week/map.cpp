...
int main() {
	...
	m.insert(std::pair<string, int>("first", 10));
	m.insert(std::pair<string, int>("second", 20));
	m.insert(std::pair<string, int>("third", 30));
	m.insert(std::pair<string, int>("fourth", 40));
